...
class BaseDumper(ABC):
    ...
    @abstractmethod
    def _dbmeta(self, metadata: Any) -> DBMetadata:
    ...
    def _write_between(
        ...
        source = dumper_src._dbmeta(metadata)
        ...
        if (
            ...
            reader.close()
            self.logger.info(f"Successfully sending {result_bytes} bytes.")
    ...
    def write_between(
        ...
        self.logger.info("Start write between servers.")
